...
--	  DetallePago		NVARCHAR(100) NOT NULL,
--	  MontoFavor		DECIMAL(10,2) NOT NULL DEFAULT 0,
...
--ALTER BD VENTAS -------------;
--ALTER TABLE Ventas
--ADD Subtotal DECIMAL(10,2) NOT NULL DEFAULT 0;

--ALTER TABLE Ventas
--ADD IVA DECIMAL(10,2) NOT NULL DEFAULT 0;

--ALTER TABLE Ventas
--ADD DetallePago NVARCHAR(100) NULL;

--ALTER TABLE Ventas
--ADD MontoAFavor DECIMAL(10,2) NOT NULL DEFAULT 0;

--ALTER TABLE Ventas
--ADD FechaResrva DATETIME NOT NULL ;
...
--EXEC sp_rename 'DetalleVenta.Subtotal', 'PrecioUnitario', 'COLUMN';
