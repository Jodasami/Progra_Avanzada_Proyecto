...
namespace VentaMusical.Controllers
{
    public class CancionesController : Controller
    {
        ...
        //                cancion.NombreGenero = datosCancion.Generos.Descripcion + " (" + datosCancion.CodigoGenero + ")";
        //                cancion.NombreAlbum = datosCancion.Albumes.NombreAlbum + " (" + datosCancion.CodigoAlbum + ")";
